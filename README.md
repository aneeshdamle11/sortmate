...
This is a part of semester 3 DSA courseware.

## Installation
```bash
$ autoreconf --install
$ ./configure
$ make install # executable like a shell command - sortmate
...
## Working
TL DR; The system does exactly what it says.
It reads the input content and it will return the same input sorted. It refers to the ASCII nomenclature.
> $ sortmate [space separated options] [input file]
